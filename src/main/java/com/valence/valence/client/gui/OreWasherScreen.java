...
public class OreWasherScreen extends AbstractContainerScreen<OreWasherMenu> {
    public OreWasherScreen(OreWasherMenu menu, Inventory inv, Component title) {
