...
public class TreeGrowthChamberScreen extends AbstractContainerScreen<TreeGrowthChamberMenu> {
    ...
    @Override protected void renderBg(GuiGraphics gg, float delta, int mx, int my) {
        ...
        // Progress + arrow area
        ValenceGui.drawLabel(gg, font, Component.literal("10s"), x+81, y+30, 0xFFAA00);
        ValenceGui.drawLabel(gg, font, Component.literal("══►"), x+81, y+44, 0x888888);
        ValenceGui.drawProgressBar(gg, x+72, y+56, 26, 4, menu.getProgress(), menu.getMaxProgress());
