...
public class TransferConduitScreen extends AbstractContainerScreen<TransferConduitMenu> {
    ...
    @Override protected void renderBg(GuiGraphics gg, float delta, int mx, int my) {
        ...
        ValenceGui.drawGaugeLabel(gg, font, "Fluid", x+35, y+75, 0x888888);

        // Center: link counts
        String src = "Src: " + menu.getSourceCount();
        String dst = "Dst: " + menu.getDestCount();
        ValenceGui.drawLabel(gg, font, Component.literal(src), x+88, y+22, 0x666666);
        ValenceGui.drawLabel(gg, font, Component.literal(dst), x+88, y+36, 0x666666);
        ValenceGui.drawLabel(gg, font, Component.literal("══►"), x+88, y+50, 0x888888);
